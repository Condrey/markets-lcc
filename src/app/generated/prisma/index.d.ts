...
export namespace Prisma {
  ...
  */
   ...
   */
  export type MarketCountOutputTypeDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * MarketCountOutputType without action
   */
  export type MarketCountOutputTypeCountEmployeesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: EmployeeWhereInput;
  };
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    market<T extends Employee$marketArgs<ExtArgs> = {}>(
      args?: Subset<T, Employee$marketArgs<ExtArgs>>,
    ): Prisma__MarketClient<
      $Result.GetResult<
        Prisma.$MarketPayload<ExtArgs>,
        T,
        "findUniqueOrThrow",
        GlobalOmitOptions
      > | null,
   ...
   * Employee.market
   */
  export type Employee$marketArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
  ...
  > = {
    where?: MarketWhereInput;
    orderBy?:
      | MarketOrderByWithAggregationInput
      | MarketOrderByWithAggregationInput[];
  ...
  export type MarketSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type MarketSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type MarketOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "name" | "location" | "mapCoordinates" | "createdAt" | "updatedAt",
    ExtArgs["result"]["market"]
  >;
  ...
  export type MarketIncludeCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  export type MarketIncludeUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  ...
  type MarketGetPayload<
    S extends boolean | null | undefined | MarketDefaultArgs,
  > = $Result.GetResult<Prisma.$MarketPayload, S>;
  ...
  export interface MarketDelegate<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > {
    [K: symbol]: {
     ...
     * })
     */
    findUnique<T extends MarketFindUniqueArgs>(
     ...
     * })
     */
    findFirst<T extends MarketFindFirstArgs>(
     ...
     *
     */
    createManyAndReturn<T extends MarketCreateManyAndReturnArgs>(
      args?: SelectSubset<T, MarketCreateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$MarketPayload<ExtArgs>,
        T,
     ...
     *
     */
    updateManyAndReturn<T extends MarketUpdateManyAndReturnArgs>(
      args: SelectSubset<T, MarketUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$MarketPayload<ExtArgs>,
        T,
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__MarketClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    employees<T extends Market$employeesArgs<ExtArgs> = {}>(
      args?: Subset<T, Market$employeesArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$EmployeePayload<ExtArgs>,
          T,
   ...
   * Market findUnique
   */
  export type MarketFindUniqueArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Market
   ...
   * Market findFirst
   */
  export type MarketFindFirstArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Market
   ...
   */
  export type MarketCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Market
   ...
   */
  export type MarketUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Market
   ...
   * Market.employees
   */
  export type Market$employeesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Employee
  ...
  export type MarketScalarWhereWithAggregatesInput = {
    ...
    mapCoordinates?:
      | StringNullableWithAggregatesFilter<"Market">
      | string
      | null;
  ...
  export type MarketCreateNestedOneWithoutEmployeesInput = {
    create?: XOR<
      MarketCreateWithoutEmployeesInput,
      MarketUncheckedCreateWithoutEmployeesInput
    >;
  ...
  export type MarketUpdateOneWithoutEmployeesNestedInput = {
    ...
    update?: XOR<
      XOR<
        MarketUpdateToOneWithWhereWithoutEmployeesInput,
        MarketUpdateWithoutEmployeesInput
      >,
      MarketUncheckedUpdateWithoutEmployeesInput
    >;
  };
  ...
  export type EmployeeCreateNestedManyWithoutMarketInput = {
    create?:
      | XOR<
          EmployeeCreateWithoutMarketInput,
          EmployeeUncheckedCreateWithoutMarketInput
        >
      | EmployeeCreateWithoutMarketInput[]
      | EmployeeUncheckedCreateWithoutMarketInput[];
    connectOrCreate?:
      | EmployeeCreateOrConnectWithoutMarketInput
      | EmployeeCreateOrConnectWithoutMarketInput[];
  ...
  export type EmployeeUpdateManyWithoutMarketNestedInput = {
    ...
    connectOrCreate?:
      ...
      | EmployeeCreateOrConnectWithoutMarketInput[];
    upsert?:
      | EmployeeUpsertWithWhereUniqueWithoutMarketInput
      | EmployeeUpsertWithWhereUniqueWithoutMarketInput[];
    createMany?: EmployeeCreateManyMarketInputEnvelope;
    set?: EmployeeWhereUniqueInput | EmployeeWhereUniqueInput[];
    disconnect?: EmployeeWhereUniqueInput | EmployeeWhereUniqueInput[];
    ...
    connect?: EmployeeWhereUniqueInput | EmployeeWhereUniqueInput[];
    update?:
      | EmployeeUpdateWithWhereUniqueWithoutMarketInput
      | EmployeeUpdateWithWhereUniqueWithoutMarketInput[];
    updateMany?:
      | EmployeeUpdateManyWithWhereWithoutMarketInput
      | EmployeeUpdateManyWithWhereWithoutMarketInput[];
    deleteMany?: EmployeeScalarWhereInput | EmployeeScalarWhereInput[];
  };
  ...
  export type EmployeeUpsertWithWhereUniqueWithoutMarketInput = {
    where: EmployeeWhereUniqueInput;
    update: XOR<
      EmployeeUpdateWithoutMarketInput,
      EmployeeUncheckedUpdateWithoutMarketInput
    >;
    create: XOR<
      EmployeeCreateWithoutMarketInput,
      EmployeeUncheckedCreateWithoutMarketInput
  ...
  export type EmployeeUpdateManyWithWhereWithoutMarketInput = {
    ...
    data: XOR<
      EmployeeUpdateManyMutationInput,
      EmployeeUncheckedUpdateManyWithoutMarketInput
    >;
  };
